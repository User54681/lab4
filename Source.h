...
public:
	...
	matrix<T> operator+(const matrix<T>& other) {
        ...
        else std::cout << "Ќельз€ посчитать сумму матриц" << "\n";
    };
	matrix<T>& operator+=(const matrix<T>& other) {
        if (m == other.m and n == other.n) {
            for (int i = 0; i < m; ++i) {
        ...
        else std::cout << "Ќельз€ прибавить одну матрицу к другой" << "\n";
    };
	matrix<T> operator-(const matrix<T>& other) {
        if (m == other.m and n == other.n) {
            matrix result(m, n);
        ...
        else std::cout << "Ќельз€ посчитать разность матриц" << "\n";
    };
	matrix<T>& operator-=(const matrix<T>& other) {
        if (m == other.m and n == other.n) {
            for (int i = 0; i < m; ++i) {
        ...
        else std::cout << "Ќельз€ вычесть из одной матрицы другую" << "\n";
    };
	matrix<T> operator*(const matrix<T>& other) {
        if (m == other.n) {
        ...
        else std::cout << "Ќевозможно посчитать произведение матриц" << "\n";
    };
